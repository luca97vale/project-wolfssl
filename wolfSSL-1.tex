...
\\Some part of the code like inclusion and global variables are omitted; you can find them on github.
...
\begin{lstlisting}[caption={int main() of SSL server},captionpos=b][language=c]
int main()
{
    int ret;
