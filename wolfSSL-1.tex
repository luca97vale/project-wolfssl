...
\end{lstlisting}
for the client.
\\\\In the WOLFSSL\_CTX can be loaded the CA (Certificate Authority) so that the client is able to verify the server's identity when they start the connection conversely. To load the CA into the WOLFSSL\_CTX there is \\\textbf{wolfSSL\_CTX\_load\_verify\_locations()}. This function requires three arguments:
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.27]{./code/img/2-client.png}
    \caption{Execute WolfSSL client}
    \label{fig:galaxy}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.27]{./code/img/3-client.png}
    \caption{Execute WolfSSL client}
    \label{fig:galaxy}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{./code/img/3-server.png}
    \caption{Execute WolfSSL client}
    \label{fig:galaxy}
\end{figure}
\begin{figure}[H]
