...
environments - primarily because of its small size, speed, and feature set; It's a SSL/TLS library optimized to run on embedded platforms.
...
\chapter{Create a program using Wolf SSL}
\section{TCP application}
To create a SSL program you can modify your TCP program added several SSL functions.
...
This application creates a chat between a client and a server.
\begin{lstlisting}[caption={int main()},captionpos=b][language=c]
...
\begin{lstlisting}[caption={clientHandler thread},captionpos=b][language=c]
...
\begin{lstlisting}[caption={readBuffer thread},captionpos=b][language=c]
...
\begin{lstlisting}[caption={writeBuffer thread},captionpos=b][language=c]
